My name is Luciano Irigoyen, and I’m currently in my third year at Epitech, where I’m pursuing a Pre-Master of Science in AI Engineering . 

I developed a prediction program for Formula 1 races, utilizing data such as grid positions, lap times, and weather conditions to predict race outcomes. I built this project using Random Forests and Gradient Boosting Machines to analyze the data and deliver accurate race predictions.

I developed as well a client segmentation using K-Means for GPS-Chile, and a data Pipeline for Aclara-REE.
